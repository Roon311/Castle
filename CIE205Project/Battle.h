...
private:
	...
	int ActiveCount=100, FrostedCount, KilledCount;	//no. of enemies (Active, Frosted, killed so far)
	int CurrentTimeStep;
	...
	Queue<Enemy*> Q_frozen_Healers; //by Rodina
	Queue<Enemy*> Q_frozen_freezers; //by Rodina
	Queue<Enemy*> Q_frozen_fighters; //by Rodina
...
public:
	...
	//void UpdateCastleInfo(int CurrentTimeStep); //by Rodina
	//
